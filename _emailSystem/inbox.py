...
number_of_mails = int(ldb.get_email_count (email_id,current_folder,"r")[0])
#print number_of_mails , n , p

print '</br>'
inbox_mails = ldb.get_emails(email_id,current_folder,n-10 ,n,"r")
print '<table align = "left"><tr>\
		<td colspan=2 align="left"><h3>'+current_folder+'_mails</h3></td></tr>\
		<tbody>'
#print '</br><tr>'
if(n <= number_of_mails ):
	print '<td><a href="redirect_page.py?page='+str(n)+'&'+'folder='+current_folder+'">next</a></td>'
if(p>=0):
	print '<td><a href="redirect_page.py?page='+str(p)+'&'+'folder='+current_folder+'">previous</a></td>'
print '</tr>'
print '<tr><td ><font size="4" color="red">from</td>\
...
for row in inbox_mails :
			...
			print '<tr><td ><font size="4" color="blue">'+ row[0]+'</td>\
