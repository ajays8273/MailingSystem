...
print "<tr><td><font size='3'><b>Priority </b></font></td><td></td><td>" + str(a[3]) + '</td><tr>'
print "<tr><td><font size='3'><b>Scheduled Time</b></font></td><td></td><td>" + str(a[6]) + '</td><tr>'
if(a[5]!=""):
